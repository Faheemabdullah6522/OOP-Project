...
- SecuGen fingerprint scanner (optional, for biometric features)

### Clone & Run

```bash
git clone https://github.com/<your-username>/QuasarEdu.git
...
The system uses SQL Server with all database operations implemented as stored procedures. A normalized 3NF schema is also available for new installations.
...
- `CreateScholarshipDatabase_Normalized.sql` — normalized 3NF schema (optional)
